...
from stonebranch_graph.domain import KIND_WORKFLOW, SOURCE_STONEBRANCH
...
from stonebranch_graph.parsers.stonebranch_workflow import add_workflow_structure_edges
